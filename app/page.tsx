...
const categorias = [
  ...
  },
  {
    ...
    icono: "💎",
    descripcion:
      "Joyería, bisutería, accesorios y relojes para complementar tu estilo.",
  },
  {
    nombre: "Hogar",
    icono: "🏠",
  ...
  },
  {
    ...
    icono: "💻🎮",
    descripcion:
      "Laptops, impresoras, accesorios, consolas, videojuegos y tecnología.",
  },
  {
    nombre: "Bebés",
    icono: "👶",
    descripcion:
      "Ropa, accesorios, carriolas, pañaleras y artículos para bebé.",
  },
  {
    nombre: "Juguetes",
    icono: "🧸",
    descripcion:
      "Juguetes, muñecas, figuras, juegos de mesa y entretenimiento infantil.",
  },
  {
    nombre: "Deportes",
    icono: "🏀",
    descripcion:
      "Ropa deportiva, accesorios, suplementos y equipo para entrenamiento.",
  },
  {
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      {/* PORTADA VERDE - BLANCO - ROJO */}
      <section className="overflow-hidden">

      <div className="grid md:grid-cols-[1fr_0.50fr_1fr]">

          {/* VERDE - TEXTO */}
          <div className="flex min-h-[460px] flex-col justify-center bg-[#006847] px-8 py-10 text-white lg:px-14">
            ...
            <div className="mt-8">
              <p className="mb-3 text-base font-bold uppercase tracking-[0.2em] text-white">
          ...
          {/* BLANCO - CENTRO LIMPIO */}
       
<div className="flex min-h-[460px] flex-col items-center justify-center bg-white px-6 text-center">

  <p className="mb-6 text-3xl font-black uppercase tracking-wider text-[#006847]">
    Mes Patrio
  </p>

  <img
    src="/bandera-mexico.jpeg"
  ...
  />
          ...
          {/* ROJO - MARCAS */}
          <div className="flex min-h-[460px] items-center justify-center bg-[#ce1126] px-8 py-10 lg:px-14">
      ...
      >
        ...
        <a
          ...
          target="_blank"
          className="mt-10 inline-block rounded-xl bg-green-600 px-7 py-4 text-lg font-bold text-white transition hover:bg-green-700"
        >
      ...
      <footer className="border-t border-slate-200 bg-white">
        <div className="mx-auto max-w-7xl px-6 py-8 text-center text-sm text-slate-500">
          ©️ 2026 Judi&apos;s Shop. Todos los derechos reservados.
        </div>
      </footer>
